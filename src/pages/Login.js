...
import { Text, AsyncStorage, ToastAndroid, Picker, View, ImageBackground } from 'react-native';
...
export default class Login extends React.Component {
    ...
    render() {
        return (
            <Content>
                <ImageBackground source={require('../../assets/img/brasil_branco.png')} style={{width: '100%', height: '100%', padding:20}}>
